...
class pppy_sedim_AROME(pppy.PPPY):
    """
    PPPY implementation for calling sedimentation schemes of AROME model.
    """
    ...
    def setup(self, init_state, duration):
        ...
        def aroini_micro_py(KULOUT, PTSTEP, LDWARM, CMICRO, CCSEDIM, LDCRIAUTI, PCRIAUTI,
                            ...
                            CCSUBG_RR_EVAP, CCSUBG_RPR_PDF, LDCRFLIMIT,
                            CCFRAC_ICE_ADJUST, PSPLIT_MAXCFL,
    ...
    def finalize(self):
        ...
        """
        super().finalize()
        del self._aroini_micro_py, self._ini_cst_py, self._sedim_py
