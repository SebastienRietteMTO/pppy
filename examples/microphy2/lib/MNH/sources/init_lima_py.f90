...
!
LOGICAL(KIND=1), INTENT (IN)       :: LNUCL_IN
LOGICAL(KIND=1), INTENT (IN)       :: LCOLD_IN
LOGICAL(KIND=1), INTENT (IN)       :: LSNOW_IN
LOGICAL(KIND=1), INTENT (IN)       :: LHAIL_IN
LOGICAL(KIND=1), INTENT (IN)       :: LHHONI_IN
LOGICAL(KIND=1), INTENT (IN)       :: LMEYERS_IN
INTEGER, INTENT (IN)       :: NMOD_IFN_IN
REAL, INTENT (IN)          :: CIFN1_IN
REAL, INTENT (IN)          :: CIFN2_IN
LOGICAL(KIND=1), INTENT (IN)       :: IFN_HOM_IN
...
!
LOGICAL(KIND=1), INTENT (IN)       :: LWARM_IN
LOGICAL(KIND=1), INTENT (IN)       :: LACTI_IN
LOGICAL(KIND=1), INTENT (IN)       :: LRAIN_IN
LOGICAL(KIND=1), INTENT (IN)       :: LSEDC_IN
LOGICAL(KIND=1), INTENT (IN)       :: LACTIT_IN
LOGICAL(KIND=1), INTENT (IN)       :: LBOUND_IN
...
LOGICAL(KIND=1), INTENT (IN)       :: CCN_HOM_IN
...
LOGICAL(KIND=1), INTENT (IN)       :: LSCAV_IN
LOGICAL(KIND=1), INTENT (IN)       :: LAERO_MASS_IN
...
IF (.NOT.ASSOCIATED(TLUOUT0)) ALLOCATE(TLUOUT0)
TLUOUT0%NLU=1
