...
"""
This an example of comparison involving LIMA microphysics parameterization
"""
...
from pppy_lima import pppy_lima
...
lima = {dt: pppy_lima(dt=dt, method='step-by-step',
                      name="LIMA" + icev + " scheme with dt=" + str(dt) + "s",
...
scheme_names = {'LIMA': lima}
long_names = {'LIMA': 'LIMA scheme'}
...
ncold = ['ni', 'ns', 'ng'] + nh
nwarm = ncold = []
comp_name = f"Test with LIMA, {state_name} state"
conf = {
